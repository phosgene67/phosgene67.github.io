export const projectsData = [
  ...
  // {
  //   id: 2,
  //   title: "Autonomous UAV (Unmanned Aerial Vehicle)",
  //   description: "Developed autonomous flight control system with GPS waypoint navigation, IMU sensor fusion, and real-time stabilization. Integrates Synbotic sensor package with STM32 microcontroller for autonomous mission planning and execution.",
  //   technologies: ["STM32", "Flight Control", "Sensor Fusion", "C/C++"],
  //   githubUrl: "https://github.com/phosgene67",
  //   demoUrl: null,
  //   status: "Completed",
  ...
  //   description: "Created intelligent automation platform using machine learning for predictive control and adaptive algorithms. Implements real-time decision-making with neural networks for autonomous system optimization and intelligent robotics applications.",
  //   technologies: ["Python", "Machine Learning", "AI/ML", "Arduino"],
  //   githubUrl: "https://github.com/phosgene67",
  //   demoUrl: null,
  //   status: "Completed",
